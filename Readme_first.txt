...
Aadpted for code 250 mini (screw head clearance is unsufficient for code 200 track)
Only tested on PECO code 250 silvernickel track (which is the hardest to bend due to spring effect)
You may need to add washers (especially on the central flanged bearings) for code 332 track for better force centering on the rail.

...
else if (xpart==51) duplpartx (nbpart,20,12) rot (90) glasslock (thkglass);
else if (xpart==52) duplpartx (nbpart,20,12) rot (90) Tglasslock (thkglass);
...
//-- Ball bearings ------------------------------------------------
// It shall be noted that for small bearings, the size is not well standardized, notably bearings without shield are smaller than when equipped with ZZ shields. All dimensions indicated in this table were given for ZZ shielded bearings.
...
module mutiline(ttext, txtsize, thktext=0.5) { //text in 'z' axis
  ltxt = len(ttext);
